...
import com.mx.blog.utils.DateUtils;
import com.mx.blog.utils.RequestUtil;
...
//    @Pointcut(“execution(* com.xjj.web.controller..*(..)) and @com.mx.blog.blog.annotation(org.springframework.web.bind.com.mx.blog.blog.annotation.RequestMapping)”)
    @Pointcut(value = "execution(* com.mx.blog.controller..*(..))")
